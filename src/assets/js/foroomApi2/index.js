...
let foroomApi = {
    params: {
        ...
        cm_array : ['gab_width', 'gab_height','cost_width', 'cost_height','width', 'height', 'rol_width', 'ControlHeight', 'DownPlumb', 'InsertSize', 'Segment1', 'Segment2', 'Segment3', 'Segment4', 'Segment5', 'Segment6', 'Segment7', 'Deflection', 'LambrBokSize', 'height2', 'height3', 'width2', 'lamels','PieceLength'],
