let ClassParamWholesaleMaterial = function(o, app) {
    this.app = app;
    this.type = o.typ;
    ...
    this.postInit = function() {
        this.link = '/calculator-wholesale/materials/' + this.app.type + this.app.subtype + '/' + this.alias + '/' + this.value + '/';
...
export default ClassParamWholesaleMaterial;