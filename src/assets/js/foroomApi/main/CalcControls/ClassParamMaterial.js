let ClassParamMaterial = function(o, app) {
    ...
    this.setVal = function(val, callback = true) {
        ...
        if (this.value === 0) this.cost = 0;
        else if (typeof this.app.materials[this.value] !== "undefined" && this.app.materials[this.value] != null) {
            ...
            if (typeof(this.materials[this.value].isCurrentAction) != 'undefined') this.isCurrentAction = this.materials[this.value].isCurrentAction;
            if (typeof(this.materials[this.value].currentActionInfo) != 'undefined') this.currentActionInfo = this.materials[this.value].currentActionInfo;
