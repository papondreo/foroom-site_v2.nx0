let ClassParamLamels = function(o, item) {
			...
			this.setValCallback = function (o) {
				if (typeof this.app.oParams !== "undefined" && this.app.oParams != null)
					if (typeof this.app.oParams.width !== "undefined" && this.app.oParams.width != null && typeof this.app.oParams.ControlSide !== "undefined" && this.app.oParams.ControlSide != null) {
						...
						let params = {
							width: this.app.oParams.width ? this.app.oParams.width.value : 0,
							count: this.oParams.count ? this.oParams.count.value : 0,
							width2: this.oParams.width2 ? this.oParams.width2.value : 0,
							height: this.app.oParams.height ? this.app.oParams.height.value : 0,
							height2: this.oParams.height2 ? this.oParams.height2.value : 0,
							height3: this.oParams.height3 ? this.oParams.height3.value : 0,
							cs: this.app.oParams.ControlSide ? this.app.oParams.ControlSide.value : 0,
							template: this.oParams.template ? this.oParams.template.value : 0,
						};
	...
	this.setVal = function (val) {
		if ((val instanceof Object) || (val instanceof Array)) {
			this.reinit = true;
			if (val.template > 0) {
				if (this.oParams.arch) this.oParams.arch.setVal(2);
				if (this.oParams.template) this.oParams.template.setVal(val.template);
				if (this.oParams.count) this.oParams.count.setVal(val.count);
				if (this.oParams.width2) this.oParams.width2.setVal(val.width2);
				if (this.oParams.height2) this.oParams.height2.setVal(val.height2);
				if (this.oParams.height3) this.oParams.height3.setVal(val.height3);
			} else if (this.oParams.arch) this.oParams.arch.setVal(1);
	...
	this.calcPrice = function (recalc, isReinit) {
		this.app.calcPrice(recalc, isReinit);
	};
		...
		if (typeof this.app !== "undefined" && this.app != null)
			if (typeof this.app.oParams !== "undefined" && this.app.oParams != null)
				if (typeof this.app.oParams.width !== "undefined" && this.app.oParams.width != null && typeof this.app.oParams.ControlSide !== "undefined" && this.app.oParams.ControlSide != null) {
					...
					if (typeof mainMat === "undefined" || mainMat == null) mainMat = 0;
					if (typeof naborkaMat === "undefined" || naborkaMat == null) naborkaMat = 0;
					let materials = [];
					...
					if (mainMat !== 0) {
						for (let k in this.arMaterials) {
							if (this.arMaterials.hasOwnProperty(k)) {
								this.arMaterials[k] = parseInt(this.arMaterials[k]);
								if (naborkaMat !== 0) {
	...
	*/
		...
		if (typeof this.app !== "undefined" && this.app != null)
			if (typeof this.app.oParams !== "undefined" && this.app.oParams != null)
				if (typeof this.app.oParams.width !== "undefined" && this.app.oParams.width != null && typeof this.app.oParams.ControlSide !== "undefined" && this.app.oParams.ControlSide != null) {
					...
					//	console.log('lamelsCalc',this.lamelsCalc);
					//console.log('this.reinit',this.reinit)
					//console.log(this, params)
					// if(('stor_temp' in this.foroomApi.params) === false){
					// 	this.foroomApi.params.stor_temp = 0;
					// }
					// if(('height2' in this.foroomApi.params) === false){
					// 	this.foroomApi.params.stor_height2 = 0;
					// }
					// if(('height3' in this.foroomApi.params) === false){
					// 	this.foroomApi.params.stor_height3 = 0;
					// }
					// if(('width2' in this.foroomApi.params) === false){
					// 	this.foroomApi.params.stor_width2 = 0;
					// }
					// let prereinit = this.reinit;
					
					// this.reinit = isReinit;

					// console.log(this.arLamels.length, this.oParams.count.value);

					
					if(this.arLamels.length != 0 && this.arLamels.length == this.oParams.count.value){
						this.reinit = isReinit;
					}	
					else{
						this.reinit = true;
					...
					// if(prereinit == true&&
					// 	(item.template && Math.max.apply(null,this.arLamels)!==(params.height)||
					// 		(params.template!==this.foroomApi.params.stor_temp)||
					// 		(params.height2 && this.foroomApi.params.stor_height2 != params.height2)||
					// 		(params.height3 && this.foroomApi.params.stor_height3 != params.height3)||
					// 		(params.width2 && this.foroomApi.params.stor_width2 != params.width2)
					// 	)
					// ){
					// 	this.reinit = true;
					// 	this.foroomApi.params.stor_temp = params.template;
					// 	if(params.height2) this.foroomApi.params.stor_height2 = params.height2;
					// 	if(params.height3) this.foroomApi.params.stor_height3 = params.height3;
					// 	if(params.width2) this.foroomApi.params.stor_width2 = params.width2;
					...
					let naborkaMainCounter = 0;
					if (mainMat !== 0) {
						for (let k in this.arMaterials) {
							if (this.arMaterials.hasOwnProperty(k)) {
								this.arMaterials[k] = parseInt(this.arMaterials[k]);
								if (naborkaMat !== 0) {
									if (this.arMaterials[k] !== mainMat && this.arMaterials[k] !== this.prevMainMat) {
										this.arMaterials[k] = naborkaMat;
										naborkaCounter++;
									} else {
										this.arMaterials[k] = mainMat;
					...
					if (naborka === 2) {
						...
						if (naborkaCounter < 4 || naborkaMainCounter < 4) this.error = true; else this.error = false;
					} else {
						this.error = false;
	...
	this.release = function (ar) {
		...
		if (arch === 2 || naborka === 2) {
			...
			//console.log('tradeAr',ret.tradeArr)
		}
		return ar;
	};
