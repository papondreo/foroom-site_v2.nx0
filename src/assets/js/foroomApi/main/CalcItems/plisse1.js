var plisse1 = function () {
	...
	this.getMaterialPrice = function (material, cost) {
		...
		//если система день ночь активирована то считаем стоимость второй ткани
		if (typeof this.oParams.Naborka !== "undefined" && this.oParams.Naborka != null){
			if( this.oParams.Naborka.value == 2){
				if (typeof this.materials[this.oParams.LambrekenMaterial] !== "undefined" && this.materials[this.oParams.LambrekenMaterial] != null){
					let price_group2 = parseInt(this.materials[this.oParams.LambrekenMaterial.value].priceGroup);
					let min_multiple2_w = 0;
					let min_multiple2_h = 0;
					let multiple_arr2 = null;
					if (typeof this.multiple_cost !== "undefined" && this.multiple_cost != null)
						if (typeof this.multiple_cost[id] !== "undefined" && this.multiple_cost[id] != null)
							if (typeof this.multiple_cost[id][price_group2] !== "undefined" && this.multiple_cost[id][price_group2] != null)
								multiple_arr2 = this.multiple_cost[id][price_group2];
					min_multiple2_w = this.get_min_from_multiple(multiple_arr2);
					if (width < min_multiple2_w) width = min_multiple2_w;
					if (width > 0)
						if (typeof this.multiple_cost !== "undefined" && this.multiple_cost != null)
							if (typeof this.multiple_cost[id] !== "undefined" && this.multiple_cost[id] != null)
								if (typeof this.multiple_cost[id][price_group2] !== "undefined" && this.multiple_cost[id][price_group2] != null)
									if (typeof this.multiple_cost[id][price_group2][width] !== "undefined" && this.multiple_cost[id][price_group2][width] != null)
										multiple_arr2 = this.multiple_cost[id][price_group2][width];
					min_multiple2_h = this.get_min_from_multiple(multiple_arr2);
					if (height < min_multiple2_h) height = min_multiple2_h;
					if (height > 0)
						if (typeof this.multiple_cost !== "undefined" && this.multiple_cost != null)
							if (typeof this.multiple_cost[id] !== "undefined" && this.multiple_cost[id] != null)
								if (typeof this.multiple_cost[id][price_group2] !== "undefined" && this.multiple_cost[id][price_group2] != null)
									if (typeof this.multiple_cost[id][price_group2][width] !== "undefined" && this.multiple_cost[id][price_group2][width] != null)
										if (typeof this.multiple_cost[id][price_group2][width][height] !== "undefined" && this.multiple_cost[id][price_group2][width][height] != null)
											tm_price += parseFloat(this.multiple_cost[id][price_group2][width][height]);
				}
			}
		}
		return tm_price;
