<template>
  <div class="filter">
    ...
    <fieldset class="mb-4">
      <template v-if="currentSystemsArray && currentSystemsArray.length">
        <ui-checkbox
          v-for="system in currentSystemsArray"
          :key="system.system"
...
export default class BestsellersProductsFilter extends Vue {
